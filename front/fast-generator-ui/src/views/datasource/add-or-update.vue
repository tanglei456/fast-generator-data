	...
	<el-dialog v-model="visible" :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false">
		<el-form ref="dataFormRef" :model="dataForm" :rules="dataRules" label-width="120px" @keyup.enter="submitHandle()">
			...
			<el-form-item prop="dbType" label="数据源类型">
				<el-select v-model="dataForm.dbType" clearable placeholder="数据源类型" style="width: 100%">
			...
			<el-form-item label="数据源URL" prop="connUrl">
				<el-input v-model="dataForm.connUrl" placeholder="数据源URL"></el-input>
			</el-form-item>
...
import { useDataSourceApi, useDataSourceSubmitApi,useDataSourceTestApi} from '@/api/datasource'
